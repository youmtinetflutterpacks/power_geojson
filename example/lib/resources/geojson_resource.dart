...
class GeoJsonResource {
  GeoJsonResource({
    ...
    this.geomType = GeoJsonGeomType.auto,
    this.data,
    this.url,
    this.isCustom = true,
  }) : id = id ?? const Uuid().v4();
  ...
  Map<String, dynamic> toJson() => {
    ...
    'geomType': geomType.name,
    'data': data,
    'url': url,
    'isCustom': isCustom,
  };

  factory GeoJsonResource.fromJson(Map<String, dynamic> json) =>
      GeoJsonResource(
        id: json['id'] as String,
        label: json['label'] as String,
        sourceType: GeoJsonSourceType.values.byName(
          json['sourceType'] as String,
        ),
        geomType: GeoJsonGeomType.values.byName(json['geomType'] as String),
        data: json['data'] as String?,
        url: json['url'] as String?,
        isCustom: json['isCustom'] as bool? ?? true,
      );

  GeoJsonResource copyWith({
    String? label,
    GeoJsonSourceType? sourceType,
    GeoJsonGeomType? geomType,
    String? data,
    String? url,
    bool? isCustom,
  }) => GeoJsonResource(
